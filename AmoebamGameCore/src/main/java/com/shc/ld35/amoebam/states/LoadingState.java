...
public class LoadingState extends GameState
{
    ...
    private int numResources = 11; // TODO: Increment this whenever we add a new resource
    ...
    public void render(float delta)
    {
        ...
        if (percentage == GAME_WIDTH - 40)
            AmoebamGame.instance.setGameState(new PlayState());
    }
    ...
    private void loadResources()
    {
        ...
        imageReader.readImage(FilePath.getResourceFile("textures/amoebam_sheet.png"), image -> {
            ...
            Resources.Animations.AMOEBAM_WALK = new Animation();
            Resources.Animations.AMOEBAM_WALK.addFrame(sheet.getCell(0, 0), 75, TimeUtils.Unit.MILLIS);
            Resources.Animations.AMOEBAM_WALK.addFrame(sheet.getCell(0, 1), 50, TimeUtils.Unit.MILLIS);
            Resources.Animations.AMOEBAM_WALK.addFrame(sheet.getCell(0, 2), 75, TimeUtils.Unit.MILLIS);
            Resources.Animations.AMOEBAM_WALK.addFrame(sheet.getCell(0, 1), 50, TimeUtils.Unit.MILLIS);

            Resources.Animations.AMOEBAM_SMALL_WALK = new Animation();
            Resources.Animations.AMOEBAM_SMALL_WALK.addFrame(sheet.getCell(0, 3), 75, TimeUtils.Unit.MILLIS);
            Resources.Animations.AMOEBAM_SMALL_WALK.addFrame(sheet.getCell(0, 4), 50, TimeUtils.Unit.MILLIS);
            Resources.Animations.AMOEBAM_SMALL_WALK.addFrame(sheet.getCell(0, 5), 75, TimeUtils.Unit.MILLIS);
            Resources.Animations.AMOEBAM_SMALL_WALK.addFrame(sheet.getCell(0, 4), 50, TimeUtils.Unit.MILLIS);
